...
public class IdCardVerification {
     ...
     * @return 错误信息或成功信息
     */
    public static boolean IDCardValidate(String IdCard) throws ParseException {
        ...
        // 18位身份证前17位为数字，如果是15位的身份证则所有号码都为数字
        if (IdCard.length() == 18) {
        ...
        if (Integer.parseInt(strMonth) > 12 || Integer.parseInt(strMonth) == 0 || Integer.parseInt(strDay) > 31 || Integer.parseInt(strDay) == 0) {
            return false;
        }
    ...
    public static void main(String[] args) throws ParseException {
        System.out.println(IdCardVerification.IDCardValidate("513436199802152000"));
    }
}