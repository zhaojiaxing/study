...
public class CatchImage {
	// 地址
	private static final String URL = "https://blog.csdn.net/zjx2016/article/details/104047888";
	// 编码
	...
	private static void DownCss(String URL) throws ClientProtocolException, IOException {
		...
		for (int i = 0; i < elements.size(); i++) {
			...
			FileUtils.copyInputStreamToFile(inputStream, new File("e://cskt//templates//css//" + css));
